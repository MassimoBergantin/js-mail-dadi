...
if (userNum > pcNum) {
    document.getElementById('dice').innerHTML += 'il tuo numero è ' + userNum + ', mentre il numero del computer è ' + pcNum + ' : complimenti hai vinto...per questa volta!';
} else if (userNum = pcNum) {
    document.getElementById('dice').innerHTML +=  'il tuo numero è ' + userNum + ', mentre il numero del computer è ' + pcNum + ' ... siete pari!';
}
else{
    document.getElementById('dice').innerHTML +=  'il tuo numero è ' + userNum + ', però il numero del computer è ' + pcNum + ' : La macchina ha vinto!';
}
